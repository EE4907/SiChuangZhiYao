...
if __name__ == "__main__":
    ...
    input_folder = 'data/data_processed'
    output_folder = 'data/featured_dataset'

    chunk_size = 40000

    for idx in range (0, 23):
        
        filename = 'split_0' + str(idx + 1).zfill(2) + '.txt'
        ...
        for i, smiles in enumerate(smiles_list):
            ...
            if (i + 1) % chunk_size == 0 or (i + 1) == N:
                part_id = ((i + 1) // chunk_size) if (i + 1) % chunk_size == 0 else (N // chunk_size + 1)
